...
class ADTwapDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ADTwap> _instance;
...
static void InitDefaultsscc_info_ADTwap_ADTwap_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::com::htsc::mdc::insight::model::_ADTwap_default_instance_;
    new (ptr) ::com::htsc::mdc::insight::model::ADTwap();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::com::htsc::mdc::insight::model::ADTwap::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ADTwap_ADTwap_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ADTwap_ADTwap_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ADTwap_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_ADTwap_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ADTwap_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ADTwap_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, periodtype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, twap_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADTwap, datamultiplepowerof10_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::com::htsc::mdc::insight::model::ADTwap)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::com::htsc::mdc::insight::model::_ADTwap_default_instance_),
};

const char descriptor_table_protodef_ADTwap_2eproto[] =
  ...
  "o3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ADTwap_2eproto_deps[3] = {
  &::descriptor_table_EMDPeriodType_2eproto,
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ADTwap_2eproto_sccs[1] = {
  &scc_info_ADTwap_ADTwap_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_ADTwap_2eproto_once;
static bool descriptor_table_ADTwap_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ADTwap_2eproto = {
  &descriptor_table_ADTwap_2eproto_initialized, descriptor_table_protodef_ADTwap_2eproto, "ADTwap.proto", 522,
  &descriptor_table_ADTwap_2eproto_once, descriptor_table_ADTwap_2eproto_sccs, descriptor_table_ADTwap_2eproto_deps, 1, 3,
  schemas, file_default_instances, TableStruct_ADTwap_2eproto::offsets,
  file_level_metadata_ADTwap_2eproto, 1, file_level_enum_descriptors_ADTwap_2eproto, file_level_service_descriptors_ADTwap_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ADTwap_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ADTwap_2eproto), true);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
void ADTwap::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ADTwap_ADTwap_2eproto.base);
  htscsecurityid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
const char* ADTwap::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_htscsecurityid(), ptr, ctx, "com.htsc.mdc.insight.model.ADTwap.HTSCSecurityID");
          CHK_(ptr);
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          twap_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void ADTwap::SerializeWithCachedSizes(
  ...
  // int64 Twap = 8;
  if (this->twap() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64(8, this->twap(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* ADTwap::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 Twap = 8;
  if (this->twap() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(8, this->twap(), target);
  }
...
void ADTwap::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:com.htsc.mdc.insight.model.ADTwap)
  GOOGLE_DCHECK_NE(&from, this);
  const ADTwap* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ADTwap>(
          &from);
  if (source == nullptr) {
...
void ADTwap::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::ADTwap* Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::ADTwap >(Arena* arena) {
  return Arena::CreateInternal< ::com::htsc::mdc::insight::model::ADTwap >(arena);
}
