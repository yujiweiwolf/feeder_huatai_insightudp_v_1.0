...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 39, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADEntryDetail)},
};
...
const ::_pbi::DescriptorTable descriptor_table_ADOrderbookSnapshot_2eproto = {
    false, false, 1323, descriptor_table_protodef_ADOrderbookSnapshot_2eproto,
...
void ADOrderbookSnapshot::InternalSwap(ADOrderbookSnapshot* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ADOrderbookSnapshot, _impl_.datamultiplepowerof10_)
      + sizeof(ADOrderbookSnapshot::_impl_.datamultiplepowerof10_)
