...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR MDOption::MDOption(
  ...
  , /*decltype(_impl_.referenceprice_)*/int64_t{0}
...
struct MDOptionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MDOptionDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MDOptionDefaultTypeInternal() {}
  union {
    MDOption _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MDOptionDefaultTypeInternal _MDOption_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_MDOption_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_MDOption_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_MDOption_2eproto = nullptr;

const uint32_t TableStruct_MDOption_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.tradingphasecode_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.maxpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.minpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.preclosepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.numtrades_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.lastpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.openpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.closepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.highpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.lowpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.diffpx1_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.diffpx2_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalbuyqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalsellqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.weightedavgbuypx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.weightedavgsellpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawbuynumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawbuyamount_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawbuymoney_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawsellnumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawsellamount_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.withdrawsellmoney_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalbuynumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.totalsellnumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.buytrademaxduration_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.selltrademaxduration_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.numbuyorders_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.numsellorders_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.tradingdate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.preopeninterest_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.presettleprice_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.openinterest_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.settleprice_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.predelta_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.currdelta_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.referenceprice_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.channelno_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.buypricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.buyorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.sellpricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.sellorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.buyorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.sellorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.buynumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.sellnumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOption, _impl_.datamultiplepowerof10_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::MDOption)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_MDOption_default_instance_._instance,
};

const char descriptor_table_protodef_MDOption_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MDOption_2eproto_deps[2] = {
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_MDOption_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_MDOption_2eproto = {
    false, false, 1537, descriptor_table_protodef_MDOption_2eproto,
    "MDOption.proto",
    &descriptor_table_MDOption_2eproto_once, descriptor_table_MDOption_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_MDOption_2eproto::offsets,
    file_level_metadata_MDOption_2eproto, file_level_enum_descriptors_MDOption_2eproto,
    file_level_service_descriptors_MDOption_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_MDOption_2eproto_getter() {
  return &descriptor_table_MDOption_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_MDOption_2eproto(&descriptor_table_MDOption_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class MDOption::_Internal {
 public:
};

MDOption::MDOption(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.MDOption)
}
MDOption::MDOption(const MDOption& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MDOption* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void MDOption::SharedCtor(
...
inline void MDOption::SharedDtor() {
...
const char* MDOption::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDOption.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      // int32 MDDate = 2;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDOption.TradingPhaseCode"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 46:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          _impl_.referenceprice_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDOption::_InternalSerialize(
  ...
  if (this->_internal_tradingdate() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(37, this->_internal_tradingdate(), target);
  }

  // int64 PreOpenInterest = 38;
  if (this->_internal_preopeninterest() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(38, this->_internal_preopeninterest(), target);
  }

  // int64 PreSettlePrice = 39;
  if (this->_internal_presettleprice() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(39, this->_internal_presettleprice(), target);
  }

  // int64 OpenInterest = 40;
  if (this->_internal_openinterest() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(40, this->_internal_openinterest(), target);
  }

  // int64 SettlePrice = 41;
  if (this->_internal_settleprice() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(41, this->_internal_settleprice(), target);
  }

  // int64 PreDelta = 42;
  if (this->_internal_predelta() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(42, this->_internal_predelta(), target);
  }

  // int64 CurrDelta = 43;
  if (this->_internal_currdelta() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(43, this->_internal_currdelta(), target);
  }

  // int32 ExchangeDate = 44;
  if (this->_internal_exchangedate() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(44, this->_internal_exchangedate(), target);
  }

  // int32 ExchangeTime = 45;
  if (this->_internal_exchangetime() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(45, this->_internal_exchangetime(), target);
  }

  // int64 ReferencePrice = 46;
  if (this->_internal_referenceprice() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(46, this->_internal_referenceprice(), target);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MDOption::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MDOption::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MDOption::GetClassData() const { return &_class_data_; }


void MDOption::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MDOption*>(&to_msg);
  auto& from = static_cast<const MDOption&>(from_msg);
  ...
  if (from._internal_referenceprice() != 0) {
    _this->_internal_set_referenceprice(from._internal_referenceprice());
  }
...
void MDOption::InternalSwap(MDOption* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDOption, _impl_.datamultiplepowerof10_)
      + sizeof(MDOption::_impl_.datamultiplepowerof10_)
      - PROTOBUF_FIELD_OFFSET(MDOption, _impl_.mddate_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata MDOption::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_MDOption_2eproto_getter, &descriptor_table_MDOption_2eproto_once,
      file_level_metadata_MDOption_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::MDOption*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::MDOption >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::MDOption >(arena);
}
