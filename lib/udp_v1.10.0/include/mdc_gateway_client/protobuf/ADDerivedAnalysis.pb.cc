...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 97, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADVr)},
  { 108, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADWr)},
};
...
const ::_pbi::DescriptorTable descriptor_table_ADDerivedAnalysis_2eproto = {
    false, false, 1700, descriptor_table_protodef_ADDerivedAnalysis_2eproto,
...
ADVmaMa::ADVmaMa(const ADVmaMa& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.nvalue_, &from._impl_.nvalue_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.ma_) -
    reinterpret_cast<char*>(&_impl_.nvalue_)) + sizeof(_impl_.ma_));
...
void ADVmaMa::InternalSwap(ADVmaMa* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ADVmaMa, _impl_.ma_)
      + sizeof(ADVmaMa::_impl_.ma_)
