...
const ::_pbi::DescriptorTable descriptor_table_MDQBQuote_2eproto = {
    false, false, 950, descriptor_table_protodef_MDQBQuote_2eproto,
    "MDQBQuote.proto",
...
void MDQBQuote::InternalSwap(MDQBQuote* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDQBQuote, _impl_.datamultiplepowerof10_)
      + sizeof(MDQBQuote::_impl_.datamultiplepowerof10_)
