...
const char descriptor_table_protodef_MessageBody_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oto\032\024HtscMarketData.proto\032\031InsightErrorC"
  "ontext.proto\032\rMDQuery.proto\032\020MDPlayback."
  "proto\"\242\013\n\013MessageBody\0226\n\004type\030\001 \001(\0162(.co"
  "m.htsc.mdc.insight.model.EMessageType\022\025\n"
  "\rinteractionId\030\002 \001(\003\022L\n\023generalErrorMess"
  "age\030\n \001(\0132/.com.htsc.mdc.insight.model.I"
  "nsightErrorContext\022>\n\014loginRequest\030\013 \001(\013"
  "2(.com.htsc.mdc.insight.model.LoginReque"
  "st\022@\n\rloginResponse\030\014 \001(\0132).com.htsc.mdc"
  ".insight.model.LoginResponse\022T\n\027serviceD"
  "iscoveryRequest\030\r \001(\01323.com.htsc.mdc.ins"
  "ight.model.ServiceDiscoveryRequest\022V\n\030se"
  "rviceDiscoveryResponse\030\016 \001(\01324.com.htsc."
  "mdc.insight.model.ServiceDiscoveryRespon"
  "se\022J\n\022mdSubscribeRequest\030\017 \001(\0132..com.hts"
  "c.mdc.insight.model.MDSubscribeRequest\022L"
  "\n\023mdSubscribeResponse\030\020 \001(\0132/.com.htsc.m"
  "dc.insight.model.MDSubscribeResponse\022B\n\016"
  "pushMarketData\030\024 \001(\0132*.com.htsc.mdc.insi"
  "ght.model.HtscMarketData\022J\n\024pushMarketDa"
  "taStream\030\025 \001(\0132,.com.htsc.mdc.insight.mo"
  "del.MarketDataStream\022B\n\016mdQueryRequest\030\036"
  " \001(\0132*.com.htsc.mdc.insight.model.MDQuer"
  "yRequest\022D\n\017mdQueryResponse\030\037 \001(\0132+.com."
  "htsc.mdc.insight.model.MDQueryResponse\022D"
  "\n\017playbackRequest\030  \001(\0132+.com.htsc.mdc.i"
  "nsight.model.PlaybackRequest\022F\n\020playback"
  "Response\030! \001(\0132,.com.htsc.mdc.insight.mo"
  "del.PlaybackResponse\022R\n\026playbackControlR"
  "equest\030\" \001(\01322.com.htsc.mdc.insight.mode"
  "l.PlaybackControlRequest\022T\n\027playbackCont"
  "rolResponse\030# \001(\01323.com.htsc.mdc.insight"
  ".model.PlaybackControlResponse\022P\n\025playba"
  "ckStatusRequest\030$ \001(\01321.com.htsc.mdc.ins"
  "ight.model.PlaybackStatusRequest\022B\n\016play"
  "backStatus\030% \001(\0132*.com.htsc.mdc.insight."
  "model.PlaybackStatus\022D\n\017playbackPayload\030"
  "& \001(\0132+.com.htsc.mdc.insight.model.Playb"
  "ackPayloadB3\n\032com.htsc.mdc.insight.model"
  "B\020MessageBodyProtoH\001\240\001\001b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MessageBody_2eproto_deps[8] = {
  &::descriptor_table_EMessageType_2eproto,
  &::descriptor_table_HtscMarketData_2eproto,
...
const ::_pbi::DescriptorTable descriptor_table_MessageBody_2eproto = {
    false, false, 1711, descriptor_table_protodef_MessageBody_2eproto,
    "MessageBody.proto",
...
class MessageBody::_Internal {
 public:
  ...
  static const ::com::htsc::mdc::insight::model::HtscMarketData& pushmarketdata(const MessageBody* msg);
...
const ::com::htsc::mdc::insight::model::HtscMarketData&
...
MessageBody::MessageBody(const MessageBody& from)
  ...
  if (from._internal_has_pushmarketdata()) {
    _this->_impl_.pushmarketdata_ = new ::com::htsc::mdc::insight::model::HtscMarketData(*from._impl_.pushmarketdata_);
  }
...
void MessageBody::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_pushmarketdata()) {
    _this->_internal_mutable_pushmarketdata()->::com::htsc::mdc::insight::model::HtscMarketData::MergeFrom(
