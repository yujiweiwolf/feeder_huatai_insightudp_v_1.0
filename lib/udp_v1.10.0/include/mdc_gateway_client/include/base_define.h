...
// 128 * 1024
#ifndef UDP_RINGBUFFER_SIZE
#define UDP_RINGBUFFER_SIZE 131072
#endif // UDP_RINGBUFFER_SIZE
// 1024 * 8
#ifndef DATA_SIZE
...
// 1024 * 128
#ifndef MAX_ORIGIN_DATA_LENGTH
#define MAX_ORIGIN_DATA_LENGTH 131072
#endif // MAX_ORIGIN_DATA_LENGTH
...
// queryType说明
const int QUERY_TYPE_BASE_INFORMATION =
    1011; //查询证券基础信息	包含到当日为止行情中心对应类型的所以基础信息，不需要特别的QueryParam
const int QUERY_TYPE_LATEST_BASE_INFORMATION =
    1012; //查询最新证券基础信息	仅包含当日有的证券基础信息，不需要特别的QueryParam
...
// Aeron dir
const std::string AERON_ROOT = "/dev/shm/";
 ...
 * 根据是否为压缩数据选择线程
 */
LIB_EXPORT void open_double_select();
LIB_EXPORT void close_double_select();
LIB_EXPORT bool is_double_select();
