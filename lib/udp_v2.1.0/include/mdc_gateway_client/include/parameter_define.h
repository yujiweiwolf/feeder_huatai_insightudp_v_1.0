...
// 流量日志输出间隔时间
const char *const HTSC_INSIGHT_CONFIG_TRAFFIC_CHECK_TIME = "traffic_check_time";
// 监测无数据最大容忍时间，单位：毫秒
...
// 双路选优
const char *const HTSC_INSIGHT_CONFIG_DOUBLE_SELECT = "double_select";
// aeron接收线程绑核
const char *const HTSC_INSIGHT_CONFIG_RECEIVER_THREAD_CPU_ID = "receiver_thread_cpu_id";
// sdk poll线程绑核
const char *const HTSC_INSIGHT_CONFIG_POLLER_THREAD_CPU_ID = "poller_thread_cpu_id";
//=======================================================================================================
//  默认参数定义
//=======================================================================================================
// 连接等待超时时间，单位：秒
...
// 流量日志输出间隔时间，单位:秒
const int TRAFFIC_CHECK_TIME = 10;
// 监测无数据最大容忍时间，单位：毫秒
const int NODATA_CHECK_GAP = 10000; // 10s
// 心跳日志开关
const int HEARTBEAT_TRACE = 0;
// 流量日志开关
...
// 双路选优
const int DOUBLE_SELECT = 0;
// 绑核
const int RECEIVER_THREAD_CPU_ID = -1;
const int POLLER_THREAD_CPU_ID = -1;
