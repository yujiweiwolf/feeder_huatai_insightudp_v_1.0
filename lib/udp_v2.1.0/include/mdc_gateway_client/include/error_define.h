...
const int RINGBUFFER_FULL = -2500;               // disruptor中环线队列已满
const int UNKNOWN_PROPERTY_NAME = -2501;         // 未知的参数名
const int INIT_AERON_CONTEXT_FAILED = -2502;     // 初始化aron失败
const int AERON_ADD_SUBSCRIPTION_FAILED = -2503; // aron添加订阅通道失败
const int AERON_ENV_ERROR = -2504;               // aron环境异常
const int BIND_CPU_NODE_ERROR = -2505;           // 绑核失败
} // namespace gateway
} // namespace mdc
} // namespace htsc
} // namespace com
