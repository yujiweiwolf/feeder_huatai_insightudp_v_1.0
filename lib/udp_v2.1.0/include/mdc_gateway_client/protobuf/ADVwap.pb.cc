...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR ADVwap::ADVwap(
...
struct ADVwapDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ADVwapDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ADVwapDefaultTypeInternal() {}
  union {
    ADVwap _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ADVwapDefaultTypeInternal _ADVwap_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_ADVwap_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_ADVwap_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_ADVwap_2eproto = nullptr;

const uint32_t TableStruct_ADVwap_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.periodtype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.volume_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.vwap_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADVwap, _impl_.datamultiplepowerof10_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADVwap)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_ADVwap_default_instance_._instance,
};

const char descriptor_table_protodef_ADVwap_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_ADVwap_2eproto_deps[3] = {
  &::descriptor_table_EMDPeriodType_2eproto,
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_ADVwap_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_ADVwap_2eproto = {
    false, false, 538, descriptor_table_protodef_ADVwap_2eproto,
    "ADVwap.proto",
    &descriptor_table_ADVwap_2eproto_once, descriptor_table_ADVwap_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_ADVwap_2eproto::offsets,
    file_level_metadata_ADVwap_2eproto, file_level_enum_descriptors_ADVwap_2eproto,
    file_level_service_descriptors_ADVwap_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_ADVwap_2eproto_getter() {
  return &descriptor_table_ADVwap_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_ADVwap_2eproto(&descriptor_table_ADVwap_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class ADVwap::_Internal {
 public:
};

ADVwap::ADVwap(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.ADVwap)
}
ADVwap::ADVwap(const ADVwap& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ADVwap* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* ADVwap::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.ADVwap.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      // int32 MDDate = 2;
...
uint8_t* ADVwap::_InternalSerialize(
  ...
  if (this->_internal_vwap() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(9, this->_internal_vwap(), target);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ADVwap::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ADVwap::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ADVwap::GetClassData() const { return &_class_data_; }


void ADVwap::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ADVwap*>(&to_msg);
  auto& from = static_cast<const ADVwap&>(from_msg);
...
void ADVwap::InternalSwap(ADVwap* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ADVwap, _impl_.datamultiplepowerof10_)
      + sizeof(ADVwap::_impl_.datamultiplepowerof10_)
      - PROTOBUF_FIELD_OFFSET(ADVwap, _impl_.mddate_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata ADVwap::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_ADVwap_2eproto_getter, &descriptor_table_ADVwap_2eproto_once,
      file_level_metadata_ADVwap_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::ADVwap*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::ADVwap >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::ADVwap >(arena);
}
