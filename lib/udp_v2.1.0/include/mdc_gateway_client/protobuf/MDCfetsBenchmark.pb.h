...
#ifndef GOOGLE_PROTOBUF_INCLUDED_MDCfetsBenchmark_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_MDCfetsBenchmark_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_MDCfetsBenchmark_2eproto
...
struct TableStruct_MDCfetsBenchmark_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDCfetsBenchmark_2eproto;
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
extern MDCfetsBenchmarkDefaultTypeInternal _MDCfetsBenchmark_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::htsc::mdc::insight::model::MDCfetsBenchmark* Arena::CreateMaybeMessage<::com::htsc::mdc::insight::model::MDCfetsBenchmark>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace htsc {
namespace mdc {
...
class MDCfetsBenchmark final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.htsc.mdc.insight.model.MDCfetsBenchmark) */ {
 public:
  inline MDCfetsBenchmark() : MDCfetsBenchmark(nullptr) {}
  ~MDCfetsBenchmark() override;
  explicit PROTOBUF_CONSTEXPR MDCfetsBenchmark(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MDCfetsBenchmark(const MDCfetsBenchmark& from);
  MDCfetsBenchmark(MDCfetsBenchmark&& from) noexcept
    : MDCfetsBenchmark() {
    *this = ::std::move(from);
  }
  ...
  inline MDCfetsBenchmark& operator=(MDCfetsBenchmark&& from) noexcept {
  ...
  static inline const MDCfetsBenchmark* internal_default_instance() {
    return reinterpret_cast<const MDCfetsBenchmark*>(
               &_MDCfetsBenchmark_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(MDCfetsBenchmark& a, MDCfetsBenchmark& b) {
    a.Swap(&b);
  }
  inline void Swap(MDCfetsBenchmark* other) {
  ...
  void UnsafeArenaSwap(MDCfetsBenchmark* other) {
    if (other == this) return;
  ...
  MDCfetsBenchmark* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MDCfetsBenchmark>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MDCfetsBenchmark& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MDCfetsBenchmark& from) {
    MDCfetsBenchmark::MergeImpl(*this, from);
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.htsc.mdc.insight.model.MDCfetsBenchmark";
  }
  protected:
  explicit MDCfetsBenchmark(::PROTOBUF_NAMESPACE_ID::Arena* arena,
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_MDCfetsBenchmark_2eproto;
};
// ===================================================================
...
void MDCfetsBenchmark::set_htscsecurityid(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsBenchmark::_internal_htscsecurityid() const {
  return _impl_.htscsecurityid_.Get();
}
inline void MDCfetsBenchmark::_internal_set_htscsecurityid(const std::string& value) {
  
  _impl_.htscsecurityid_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsBenchmark::_internal_mutable_htscsecurityid() {
...
inline ::com::htsc::mdc::model::ESecurityType MDCfetsBenchmark::_internal_securitytype() const {
...
inline void MDCfetsBenchmark::_internal_set_securitytype(::com::htsc::mdc::model::ESecurityType value) {
...
inline ::com::htsc::mdc::model::ESecurityIDSource MDCfetsBenchmark::_internal_securityidsource() const {
...
inline void MDCfetsBenchmark::_internal_set_securityidsource(::com::htsc::mdc::model::ESecurityIDSource value) {
...
inline int32_t MDCfetsBenchmark::_internal_mddate() const {
  return _impl_.mddate_;
}
inline int32_t MDCfetsBenchmark::mddate() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsBenchmark.MDDate)
  return _internal_mddate();
}
inline void MDCfetsBenchmark::_internal_set_mddate(int32_t value) {
  
  _impl_.mddate_ = value;
}
inline void MDCfetsBenchmark::set_mddate(int32_t value) {
...
inline int32_t MDCfetsBenchmark::_internal_mdtime() const {
  return _impl_.mdtime_;
}
inline int32_t MDCfetsBenchmark::mdtime() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsBenchmark.MDTime)
  return _internal_mdtime();
}
inline void MDCfetsBenchmark::_internal_set_mdtime(int32_t value) {
  
  _impl_.mdtime_ = value;
}
inline void MDCfetsBenchmark::set_mdtime(int32_t value) {
...
inline int64_t MDCfetsBenchmark::_internal_datatimestamp() const {
  return _impl_.datatimestamp_;
}
inline int64_t MDCfetsBenchmark::datatimestamp() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsBenchmark.DataTimestamp)
  return _internal_datatimestamp();
}
inline void MDCfetsBenchmark::_internal_set_datatimestamp(int64_t value) {
  
  _impl_.datatimestamp_ = value;
}
inline void MDCfetsBenchmark::set_datatimestamp(int64_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsBenchmark::set_transacttime(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsBenchmark::_internal_transacttime() const {
  return _impl_.transacttime_.Get();
}
inline void MDCfetsBenchmark::_internal_set_transacttime(const std::string& value) {
  
  _impl_.transacttime_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsBenchmark::_internal_mutable_transacttime() {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsBenchmark::set_marketindicator(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsBenchmark::_internal_marketindicator() const {
  return _impl_.marketindicator_.Get();
}
inline void MDCfetsBenchmark::_internal_set_marketindicator(const std::string& value) {
  
  _impl_.marketindicator_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsBenchmark::_internal_mutable_marketindicator() {
...
inline int32_t MDCfetsBenchmark::_internal_datamultiplepowerof10() const {
  return _impl_.datamultiplepowerof10_;
}
inline int32_t MDCfetsBenchmark::datamultiplepowerof10() const {
...
inline void MDCfetsBenchmark::_internal_set_datamultiplepowerof10(int32_t value) {
  
  _impl_.datamultiplepowerof10_ = value;
}
inline void MDCfetsBenchmark::set_datamultiplepowerof10(int32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_MDCfetsBenchmark_2eproto
