...
#ifndef GOOGLE_PROTOBUF_INCLUDED_MDCfetsCurrencyDeal_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_MDCfetsCurrencyDeal_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_MDCfetsCurrencyDeal_2eproto
...
struct TableStruct_MDCfetsCurrencyDeal_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDCfetsCurrencyDeal_2eproto;
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
extern MDCfetsCurrencyDealDefaultTypeInternal _MDCfetsCurrencyDeal_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::htsc::mdc::insight::model::MDCfetsCurrencyDeal* Arena::CreateMaybeMessage<::com::htsc::mdc::insight::model::MDCfetsCurrencyDeal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace htsc {
namespace mdc {
...
class MDCfetsCurrencyDeal final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.htsc.mdc.insight.model.MDCfetsCurrencyDeal) */ {
 public:
  inline MDCfetsCurrencyDeal() : MDCfetsCurrencyDeal(nullptr) {}
  ~MDCfetsCurrencyDeal() override;
  explicit PROTOBUF_CONSTEXPR MDCfetsCurrencyDeal(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MDCfetsCurrencyDeal(const MDCfetsCurrencyDeal& from);
  MDCfetsCurrencyDeal(MDCfetsCurrencyDeal&& from) noexcept
    : MDCfetsCurrencyDeal() {
    *this = ::std::move(from);
  }
  ...
  inline MDCfetsCurrencyDeal& operator=(MDCfetsCurrencyDeal&& from) noexcept {
  ...
  static inline const MDCfetsCurrencyDeal* internal_default_instance() {
    return reinterpret_cast<const MDCfetsCurrencyDeal*>(
               &_MDCfetsCurrencyDeal_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(MDCfetsCurrencyDeal& a, MDCfetsCurrencyDeal& b) {
    a.Swap(&b);
  }
  inline void Swap(MDCfetsCurrencyDeal* other) {
  ...
  void UnsafeArenaSwap(MDCfetsCurrencyDeal* other) {
    if (other == this) return;
  ...
  MDCfetsCurrencyDeal* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MDCfetsCurrencyDeal>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MDCfetsCurrencyDeal& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MDCfetsCurrencyDeal& from) {
    MDCfetsCurrencyDeal::MergeImpl(*this, from);
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.htsc.mdc.insight.model.MDCfetsCurrencyDeal";
  }
  protected:
  explicit MDCfetsCurrencyDeal(::PROTOBUF_NAMESPACE_ID::Arena* arena,
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_MDCfetsCurrencyDeal_2eproto;
};
// ===================================================================
...
void MDCfetsCurrencyDeal::set_htscsecurityid(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsCurrencyDeal::_internal_htscsecurityid() const {
  return _impl_.htscsecurityid_.Get();
}
inline void MDCfetsCurrencyDeal::_internal_set_htscsecurityid(const std::string& value) {
  
  _impl_.htscsecurityid_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsCurrencyDeal::_internal_mutable_htscsecurityid() {
...
inline ::com::htsc::mdc::model::ESecurityType MDCfetsCurrencyDeal::_internal_securitytype() const {
...
inline void MDCfetsCurrencyDeal::_internal_set_securitytype(::com::htsc::mdc::model::ESecurityType value) {
...
inline ::com::htsc::mdc::model::ESecurityIDSource MDCfetsCurrencyDeal::_internal_securityidsource() const {
...
inline void MDCfetsCurrencyDeal::_internal_set_securityidsource(::com::htsc::mdc::model::ESecurityIDSource value) {
...
inline int32_t MDCfetsCurrencyDeal::_internal_mddate() const {
  return _impl_.mddate_;
}
inline int32_t MDCfetsCurrencyDeal::mddate() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsCurrencyDeal.MDDate)
  return _internal_mddate();
}
inline void MDCfetsCurrencyDeal::_internal_set_mddate(int32_t value) {
  
  _impl_.mddate_ = value;
}
inline void MDCfetsCurrencyDeal::set_mddate(int32_t value) {
...
inline int32_t MDCfetsCurrencyDeal::_internal_mdtime() const {
  return _impl_.mdtime_;
}
inline int32_t MDCfetsCurrencyDeal::mdtime() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsCurrencyDeal.MDTime)
  return _internal_mdtime();
}
inline void MDCfetsCurrencyDeal::_internal_set_mdtime(int32_t value) {
  
  _impl_.mdtime_ = value;
}
inline void MDCfetsCurrencyDeal::set_mdtime(int32_t value) {
...
inline int64_t MDCfetsCurrencyDeal::_internal_datatimestamp() const {
  return _impl_.datatimestamp_;
}
inline int64_t MDCfetsCurrencyDeal::datatimestamp() const {
...
inline void MDCfetsCurrencyDeal::_internal_set_datatimestamp(int64_t value) {
  
  _impl_.datatimestamp_ = value;
}
inline void MDCfetsCurrencyDeal::set_datatimestamp(int64_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsCurrencyDeal::set_transacttime(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsCurrencyDeal::_internal_transacttime() const {
  return _impl_.transacttime_.Get();
}
inline void MDCfetsCurrencyDeal::_internal_set_transacttime(const std::string& value) {
  
  _impl_.transacttime_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsCurrencyDeal::_internal_mutable_transacttime() {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsCurrencyDeal::set_marketindicator(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsCurrencyDeal::_internal_marketindicator() const {
  return _impl_.marketindicator_.Get();
}
inline void MDCfetsCurrencyDeal::_internal_set_marketindicator(const std::string& value) {
  
  _impl_.marketindicator_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsCurrencyDeal::_internal_mutable_marketindicator() {
...
inline int32_t MDCfetsCurrencyDeal::_internal_datamultiplepowerof10() const {
  return _impl_.datamultiplepowerof10_;
}
inline int32_t MDCfetsCurrencyDeal::datamultiplepowerof10() const {
...
inline void MDCfetsCurrencyDeal::_internal_set_datamultiplepowerof10(int32_t value) {
  
  _impl_.datamultiplepowerof10_ = value;
}
inline void MDCfetsCurrencyDeal::set_datamultiplepowerof10(int32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_MDCfetsCurrencyDeal_2eproto
