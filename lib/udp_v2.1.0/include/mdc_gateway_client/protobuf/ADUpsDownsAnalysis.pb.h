...
class ADUpsDownsCount final :
 ...
 public:
  ...
  private:
  int _internal_leadingupids_size() const;
  public:
  ...
  void set_leadingupids(int index, std::string&& value);
  ...
  void add_leadingupids(std::string&& value);
  void add_leadingupids(const char* value);
  void add_leadingupids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& leadingupids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_leadingupids();
  private:
  const std::string& _internal_leadingupids(int index) const;
  std::string* _internal_add_leadingupids();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> leadingupids_;
    int32_t ups_;
    int32_t downs_;
    int32_t equals_;
    int32_t preups_;
...
// repeated string LeadingUpIds = 9;
inline int ADUpsDownsCount::_internal_leadingupids_size() const {
  return _impl_.leadingupids_.size();
}
inline int ADUpsDownsCount::leadingupids_size() const {
  return _internal_leadingupids_size();
}
inline void ADUpsDownsCount::clear_leadingupids() {
  _impl_.leadingupids_.Clear();
}
inline std::string* ADUpsDownsCount::add_leadingupids() {
  std::string* _s = _internal_add_leadingupids();
  // @@protoc_insertion_point(field_add_mutable:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
  return _s;
}
inline const std::string& ADUpsDownsCount::_internal_leadingupids(int index) const {
  return _impl_.leadingupids_.Get(index);
}
inline const std::string& ADUpsDownsCount::leadingupids(int index) const {
  ...
  return _internal_leadingupids(index);
}
inline std::string* ADUpsDownsCount::mutable_leadingupids(int index) {
  ...
  return _impl_.leadingupids_.Mutable(index);
}
inline void ADUpsDownsCount::set_leadingupids(int index, const std::string& value) {
  _impl_.leadingupids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
}
inline void ADUpsDownsCount::set_leadingupids(int index, std::string&& value) {
  _impl_.leadingupids_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
}
...
inline void ADUpsDownsCount::set_leadingupids(int index, const char* value, size_t size) {
  _impl_.leadingupids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
}
inline std::string* ADUpsDownsCount::_internal_add_leadingupids() {
  return _impl_.leadingupids_.Add();
}
inline void ADUpsDownsCount::add_leadingupids(const std::string& value) {
  _impl_.leadingupids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
}
inline void ADUpsDownsCount::add_leadingupids(std::string&& value) {
  _impl_.leadingupids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds)
}
...
inline void ADUpsDownsCount::add_leadingupids(const char* value, size_t size) {
  _impl_.leadingupids_.Add()->assign(reinterpret_cast<const char*>(value), size);
