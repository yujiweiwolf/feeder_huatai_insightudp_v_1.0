...
enum EMDTickLevel : int {
  ...
  TICK_LEVEL_TEN = 4,
  TICK_LEVEL_ALL = 5,
  EMDTickLevel_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  EMDTickLevel_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool EMDTickLevel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EMDTickLevel* value) {
