...
PROTOBUF_CONSTEXPR MDOrder::MDOrder(
  ...
  , /*decltype(_impl_.tradedqty_)*/int64_t{0}
...
const uint32_t TableStruct_MDOrder_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDOrder, _impl_.tradedqty_),
};
...
const char descriptor_table_protodef_MDOrder_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "nsight.modelB\rMDOrderProtosH\001\240\001\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_MDOrder_2eproto = {
    false, false, 960, descriptor_table_protodef_MDOrder_2eproto,
    "MDOrder.proto",
...
MDOrder::MDOrder(const MDOrder& from)
  ...
  ::memcpy(&_impl_.mddate_, &from._impl_.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.tradedqty_) -
    reinterpret_cast<char*>(&_impl_.mddate_)) + sizeof(_impl_.tradedqty_));
...
// @@protoc_insertion_point(message_clear_start:com.htsc.mdc.insight.model.MDOrder)
  ...
  ::memset(&_impl_.mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.tradedqty_) -
      reinterpret_cast<char*>(&_impl_.mddate_)) + sizeof(_impl_.tradedqty_));
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 35:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _impl_.tradedqty_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDOrder::_InternalSerialize(
  ...
  // int64 TradedQty = 35;
  if (this->_internal_tradedqty() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(35, this->_internal_tradedqty(), target);
  }
...
void MDOrder::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_tradedqty() != 0) {
    _this->_internal_set_tradedqty(from._internal_tradedqty());
  }
...
void MDOrder::InternalSwap(MDOrder* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDOrder, _impl_.tradedqty_)
      + sizeof(MDOrder::_impl_.tradedqty_)
