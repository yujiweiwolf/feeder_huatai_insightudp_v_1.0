...
#ifndef GOOGLE_PROTOBUF_INCLUDED_MDCfetsRateDeal_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_MDCfetsRateDeal_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_MDCfetsRateDeal_2eproto
...
struct TableStruct_MDCfetsRateDeal_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDCfetsRateDeal_2eproto;
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
extern MDCfetsRateDealDefaultTypeInternal _MDCfetsRateDeal_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::htsc::mdc::insight::model::MDCfetsRateDeal* Arena::CreateMaybeMessage<::com::htsc::mdc::insight::model::MDCfetsRateDeal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace htsc {
namespace mdc {
...
class MDCfetsRateDeal final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.htsc.mdc.insight.model.MDCfetsRateDeal) */ {
 public:
  inline MDCfetsRateDeal() : MDCfetsRateDeal(nullptr) {}
  ~MDCfetsRateDeal() override;
  explicit PROTOBUF_CONSTEXPR MDCfetsRateDeal(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MDCfetsRateDeal(const MDCfetsRateDeal& from);
  MDCfetsRateDeal(MDCfetsRateDeal&& from) noexcept
    : MDCfetsRateDeal() {
    *this = ::std::move(from);
  }
  ...
  inline MDCfetsRateDeal& operator=(MDCfetsRateDeal&& from) noexcept {
  ...
  static inline const MDCfetsRateDeal* internal_default_instance() {
    return reinterpret_cast<const MDCfetsRateDeal*>(
               &_MDCfetsRateDeal_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(MDCfetsRateDeal& a, MDCfetsRateDeal& b) {
    a.Swap(&b);
  }
  inline void Swap(MDCfetsRateDeal* other) {
  ...
  void UnsafeArenaSwap(MDCfetsRateDeal* other) {
    if (other == this) return;
  ...
  MDCfetsRateDeal* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MDCfetsRateDeal>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MDCfetsRateDeal& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MDCfetsRateDeal& from) {
    MDCfetsRateDeal::MergeImpl(*this, from);
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.htsc.mdc.insight.model.MDCfetsRateDeal";
  }
  protected:
  explicit MDCfetsRateDeal(::PROTOBUF_NAMESPACE_ID::Arena* arena,
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_MDCfetsRateDeal_2eproto;
};
// ===================================================================
...
void MDCfetsRateDeal::set_htscsecurityid(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsRateDeal::_internal_htscsecurityid() const {
  return _impl_.htscsecurityid_.Get();
}
inline void MDCfetsRateDeal::_internal_set_htscsecurityid(const std::string& value) {
  
  _impl_.htscsecurityid_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsRateDeal::_internal_mutable_htscsecurityid() {
...
inline ::com::htsc::mdc::model::ESecurityType MDCfetsRateDeal::_internal_securitytype() const {
...
inline void MDCfetsRateDeal::_internal_set_securitytype(::com::htsc::mdc::model::ESecurityType value) {
...
inline ::com::htsc::mdc::model::ESecurityIDSource MDCfetsRateDeal::_internal_securityidsource() const {
...
inline void MDCfetsRateDeal::_internal_set_securityidsource(::com::htsc::mdc::model::ESecurityIDSource value) {
...
inline int32_t MDCfetsRateDeal::_internal_mddate() const {
  return _impl_.mddate_;
}
inline int32_t MDCfetsRateDeal::mddate() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsRateDeal.MDDate)
  return _internal_mddate();
}
inline void MDCfetsRateDeal::_internal_set_mddate(int32_t value) {
  
  _impl_.mddate_ = value;
}
inline void MDCfetsRateDeal::set_mddate(int32_t value) {
...
inline int32_t MDCfetsRateDeal::_internal_mdtime() const {
  return _impl_.mdtime_;
}
inline int32_t MDCfetsRateDeal::mdtime() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsRateDeal.MDTime)
  return _internal_mdtime();
}
inline void MDCfetsRateDeal::_internal_set_mdtime(int32_t value) {
  
  _impl_.mdtime_ = value;
}
inline void MDCfetsRateDeal::set_mdtime(int32_t value) {
...
inline int64_t MDCfetsRateDeal::_internal_datatimestamp() const {
  return _impl_.datatimestamp_;
}
inline int64_t MDCfetsRateDeal::datatimestamp() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDCfetsRateDeal.DataTimestamp)
  return _internal_datatimestamp();
}
inline void MDCfetsRateDeal::_internal_set_datatimestamp(int64_t value) {
  
  _impl_.datatimestamp_ = value;
}
inline void MDCfetsRateDeal::set_datatimestamp(int64_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsRateDeal::set_transacttime(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsRateDeal::_internal_transacttime() const {
  return _impl_.transacttime_.Get();
}
inline void MDCfetsRateDeal::_internal_set_transacttime(const std::string& value) {
  
  _impl_.transacttime_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsRateDeal::_internal_mutable_transacttime() {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MDCfetsRateDeal::set_marketindicator(ArgT0&& arg0, ArgT... args) {
...
inline const std::string& MDCfetsRateDeal::_internal_marketindicator() const {
  return _impl_.marketindicator_.Get();
}
inline void MDCfetsRateDeal::_internal_set_marketindicator(const std::string& value) {
  
  _impl_.marketindicator_.Set(value, GetArenaForAllocation());
}
inline std::string* MDCfetsRateDeal::_internal_mutable_marketindicator() {
...
inline int32_t MDCfetsRateDeal::_internal_datamultiplepowerof10() const {
  return _impl_.datamultiplepowerof10_;
}
inline int32_t MDCfetsRateDeal::datamultiplepowerof10() const {
...
inline void MDCfetsRateDeal::_internal_set_datamultiplepowerof10(int32_t value) {
  
  _impl_.datamultiplepowerof10_ = value;
}
inline void MDCfetsRateDeal::set_datamultiplepowerof10(int32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_MDCfetsRateDeal_2eproto
