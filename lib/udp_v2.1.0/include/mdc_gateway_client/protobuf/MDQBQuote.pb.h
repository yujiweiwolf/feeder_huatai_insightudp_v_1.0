...
class MDQBQuote final :
 ...
 public:
  ...
  enum : int {
    ...
    kBidFullPriceFieldNumber = 34,
    kDataMultiplePowerOf10FieldNumber = 33,
    kBidPriceTypeFieldNumber = 36,
    kOfrFullPriceFieldNumber = 35,
    kOfrPriceTypeFieldNumber = 37,
  };
  ...
  int64_t bidfullprice() const;
  void set_bidfullprice(int64_t value);
  private:
  int64_t _internal_bidfullprice() const;
  void _internal_set_bidfullprice(int64_t value);
  public:
  ...
  int32_t bidpricetype() const;
  void set_bidpricetype(int32_t value);
  private:
  int32_t _internal_bidpricetype() const;
  void _internal_set_bidpricetype(int32_t value);
  public:

  // int64 OfrFullPrice = 35;
  void clear_ofrfullprice();
  int64_t ofrfullprice() const;
  void set_ofrfullprice(int64_t value);
  private:
  int64_t _internal_ofrfullprice() const;
  void _internal_set_ofrfullprice(int64_t value);
  public:

  // int32 OfrPriceType = 37;
  void clear_ofrpricetype();
  int32_t ofrpricetype() const;
  void set_ofrpricetype(int32_t value);
  private:
  int32_t _internal_ofrpricetype() const;
  void _internal_set_ofrpricetype(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int64_t bidfullprice_;
    int32_t datamultiplepowerof10_;
    int32_t bidpricetype_;
    int64_t ofrfullprice_;
    int32_t ofrpricetype_;
...
inline void MDQBQuote::clear_bidfullprice() {
  _impl_.bidfullprice_ = int64_t{0};
}
inline int64_t MDQBQuote::_internal_bidfullprice() const {
  return _impl_.bidfullprice_;
}
inline int64_t MDQBQuote::bidfullprice() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDQBQuote.BidFullPrice)
  return _internal_bidfullprice();
}
inline void MDQBQuote::_internal_set_bidfullprice(int64_t value) {
  
  _impl_.bidfullprice_ = value;
}
inline void MDQBQuote::set_bidfullprice(int64_t value) {
  _internal_set_bidfullprice(value);
...
inline void MDQBQuote::clear_ofrfullprice() {
  _impl_.ofrfullprice_ = int64_t{0};
}
inline int64_t MDQBQuote::_internal_ofrfullprice() const {
  return _impl_.ofrfullprice_;
}
inline int64_t MDQBQuote::ofrfullprice() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDQBQuote.OfrFullPrice)
  return _internal_ofrfullprice();
}
inline void MDQBQuote::_internal_set_ofrfullprice(int64_t value) {
  
  _impl_.ofrfullprice_ = value;
}
inline void MDQBQuote::set_ofrfullprice(int64_t value) {
  _internal_set_ofrfullprice(value);
...
inline void MDQBQuote::clear_bidpricetype() {
  _impl_.bidpricetype_ = 0;
}
inline int32_t MDQBQuote::_internal_bidpricetype() const {
  return _impl_.bidpricetype_;
}
inline int32_t MDQBQuote::bidpricetype() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDQBQuote.BidPriceType)
  return _internal_bidpricetype();
}
inline void MDQBQuote::_internal_set_bidpricetype(int32_t value) {
  
  _impl_.bidpricetype_ = value;
}
inline void MDQBQuote::set_bidpricetype(int32_t value) {
  _internal_set_bidpricetype(value);
...
inline void MDQBQuote::clear_ofrpricetype() {
  _impl_.ofrpricetype_ = 0;
}
inline int32_t MDQBQuote::_internal_ofrpricetype() const {
  return _impl_.ofrpricetype_;
}
inline int32_t MDQBQuote::ofrpricetype() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDQBQuote.OfrPriceType)
  return _internal_ofrpricetype();
}
inline void MDQBQuote::_internal_set_ofrpricetype(int32_t value) {
  
  _impl_.ofrpricetype_ = value;
}
inline void MDQBQuote::set_ofrpricetype(int32_t value) {
  _internal_set_ofrpricetype(value);
