...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR MDIopvSnapshot::MDIopvSnapshot(
  ...
  , /*decltype(_impl_.exchangetime_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  ...
  , /*decltype(_impl_.arrivaldatetime_)*/int64_t{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct MDIopvSnapshotDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MDIopvSnapshotDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MDIopvSnapshotDefaultTypeInternal() {}
  union {
    MDIopvSnapshot _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MDIopvSnapshotDefaultTypeInternal _MDIopvSnapshot_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_MDIopvSnapshot_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_MDIopvSnapshot_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_MDIopvSnapshot_2eproto = nullptr;

const uint32_t TableStruct_MDIopvSnapshot_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.tradingphasecode_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.iopv_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.datamultiplepowerof10_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.channelno_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.applseqnum_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDIopvSnapshot, _impl_.arrivaldatetime_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::MDIopvSnapshot)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_MDIopvSnapshot_default_instance_._instance,
};

const char descriptor_table_protodef_MDIopvSnapshot_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "modelB\024MDIopvSnapshotProtosH\001\240\001\001b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MDIopvSnapshot_2eproto_deps[2] = {
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_MDIopvSnapshot_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_MDIopvSnapshot_2eproto = {
    false, false, 560, descriptor_table_protodef_MDIopvSnapshot_2eproto,
    "MDIopvSnapshot.proto",
    &descriptor_table_MDIopvSnapshot_2eproto_once, descriptor_table_MDIopvSnapshot_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_MDIopvSnapshot_2eproto::offsets,
    file_level_metadata_MDIopvSnapshot_2eproto, file_level_enum_descriptors_MDIopvSnapshot_2eproto,
    file_level_service_descriptors_MDIopvSnapshot_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_MDIopvSnapshot_2eproto_getter() {
  return &descriptor_table_MDIopvSnapshot_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_MDIopvSnapshot_2eproto(&descriptor_table_MDIopvSnapshot_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class MDIopvSnapshot::_Internal {
 public:
};

MDIopvSnapshot::MDIopvSnapshot(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.MDIopvSnapshot)
}
MDIopvSnapshot::MDIopvSnapshot(const MDIopvSnapshot& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MDIopvSnapshot* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  _impl_.exchangetime_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.exchangetime_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_exchangetime().empty()) {
    _this->_impl_.exchangetime_.Set(from._internal_exchangetime(), 
      _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.securitytype_, &from._impl_.securitytype_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.arrivaldatetime_) -
    reinterpret_cast<char*>(&_impl_.securitytype_)) + sizeof(_impl_.arrivaldatetime_));
  // @@protoc_insertion_point(copy_constructor:com.htsc.mdc.insight.model.MDIopvSnapshot)
}

inline void MDIopvSnapshot::SharedCtor(
...
// @@protoc_insertion_point(message_clear_start:com.htsc.mdc.insight.model.MDIopvSnapshot)
  ...
  ::memset(&_impl_.securitytype_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.arrivaldatetime_) -
      reinterpret_cast<char*>(&_impl_.securitytype_)) + sizeof(_impl_.arrivaldatetime_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* MDIopvSnapshot::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDIopvSnapshot.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDIopvSnapshot.TradingPhaseCode"));
        } else
          goto handle_unusual;
        continue;
      // int64 IOPV = 8;
      ...
      case 21:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 170)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDIopvSnapshot.ExchangeDate"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 178)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDIopvSnapshot.ExchangeTime"));
        } else
          goto handle_unusual;
        continue;
      // int32 ChannelNo = 23;
      ...
      case 25:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 200)) {
          _impl_.arrivaldatetime_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDIopvSnapshot::_InternalSerialize(
  ...
  if (!this->_internal_tradingphasecode().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        7, this->_internal_tradingphasecode(), target);
  }

  // int64 IOPV = 8;
  if (this->_internal_iopv() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(8, this->_internal_iopv(), target);
  }
  ...
  if (!this->_internal_exchangedate().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        21, this->_internal_exchangedate(), target);
  }

  // string ExchangeTime = 22;
  if (!this->_internal_exchangetime().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
    ...
    target = stream->WriteStringMaybeAliased(
        22, this->_internal_exchangetime(), target);
  }

  // int32 ChannelNo = 23;
  if (this->_internal_channelno() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(23, this->_internal_channelno(), target);
  }

  // int64 ApplSeqNum = 24;
  if (this->_internal_applseqnum() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(24, this->_internal_applseqnum(), target);
  }

  // int64 ArrivalDateTime = 25;
  if (this->_internal_arrivaldatetime() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(25, this->_internal_arrivaldatetime(), target);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MDIopvSnapshot::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MDIopvSnapshot::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MDIopvSnapshot::GetClassData() const { return &_class_data_; }


void MDIopvSnapshot::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MDIopvSnapshot*>(&to_msg);
  auto& from = static_cast<const MDIopvSnapshot&>(from_msg);
  ...
  if (from._internal_arrivaldatetime() != 0) {
...
void MDIopvSnapshot::InternalSwap(MDIopvSnapshot* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.exchangetime_, lhs_arena,
      &other->_impl_.exchangetime_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDIopvSnapshot, _impl_.arrivaldatetime_)
      + sizeof(MDIopvSnapshot::_impl_.arrivaldatetime_)
      - PROTOBUF_FIELD_OFFSET(MDIopvSnapshot, _impl_.securitytype_)>(
          reinterpret_cast<char*>(&_impl_.securitytype_),
          reinterpret_cast<char*>(&other->_impl_.securitytype_));
}

::PROTOBUF_NAMESPACE_ID::Metadata MDIopvSnapshot::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_MDIopvSnapshot_2eproto_getter, &descriptor_table_MDIopvSnapshot_2eproto_once,
      file_level_metadata_MDIopvSnapshot_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::MDIopvSnapshot*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::MDIopvSnapshot >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::MDIopvSnapshot >(arena);
}
