...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR MDWarrant::MDWarrant(
  ...
  , /*decltype(_impl_.warrantpremiumrate_)*/int64_t{0}
  , /*decltype(_impl_.totalwarrantexecuteqty_)*/int64_t{0}
  , /*decltype(_impl_.totalwarrantcreateqty_)*/int64_t{0}
  , /*decltype(_impl_.totalwarrantcancelqty_)*/int64_t{0}
...
struct MDWarrantDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MDWarrantDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MDWarrantDefaultTypeInternal() {}
  union {
    MDWarrant _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MDWarrantDefaultTypeInternal _MDWarrant_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_MDWarrant_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_MDWarrant_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_MDWarrant_2eproto = nullptr;

const uint32_t TableStruct_MDWarrant_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.tradingphasecode_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.maxpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.minpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.preclosepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.numtrades_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.lastpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.openpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.closepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.highpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.lowpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.diffpx1_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.diffpx2_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalbuyqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalsellqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.weightedavgbuypx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.weightedavgsellpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawbuynumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawbuyamount_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawbuymoney_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawsellnumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawsellamount_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.withdrawsellmoney_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalbuynumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalsellnumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.buytrademaxduration_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.selltrademaxduration_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.numbuyorders_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.numsellorders_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.warrantpremiumrate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalwarrantexecuteqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalwarrantcreateqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.totalwarrantcancelqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.channelno_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.buypricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.buyorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.sellpricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.sellorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.buyorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.sellorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.buynumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.sellnumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.norminalpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.shortsellsharestraded_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.shortsellturnover_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.premarketlastpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.premarkettotalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.premarkettotalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.premarkethighpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.premarketlowpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.afterhourslastpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.afterhourstotalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.afterhourstotalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.afterhourshighpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.afterhourslowpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.marketphasecode_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.usconsolidatevolume_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.uscompositeclosepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.tradinghaltreason_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.otctotalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.otctotalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.otcnumtrades_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDWarrant, _impl_.datamultiplepowerof10_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::MDWarrant)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_MDWarrant_default_instance_._instance,
};

const char descriptor_table_protodef_MDWarrant_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "roto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MDWarrant_2eproto_deps[2] = {
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_MDWarrant_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_MDWarrant_2eproto = {
    false, false, 2045, descriptor_table_protodef_MDWarrant_2eproto,
    "MDWarrant.proto",
    &descriptor_table_MDWarrant_2eproto_once, descriptor_table_MDWarrant_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_MDWarrant_2eproto::offsets,
    file_level_metadata_MDWarrant_2eproto, file_level_enum_descriptors_MDWarrant_2eproto,
    file_level_service_descriptors_MDWarrant_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_MDWarrant_2eproto_getter() {
  return &descriptor_table_MDWarrant_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_MDWarrant_2eproto(&descriptor_table_MDWarrant_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class MDWarrant::_Internal {
 public:
};

MDWarrant::MDWarrant(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.MDWarrant)
}
MDWarrant::MDWarrant(const MDWarrant& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MDWarrant* const _this = this; (void)_this;
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.warrantpremiumrate_){}
    , decltype(_impl_.totalwarrantexecuteqty_){}
    , decltype(_impl_.totalwarrantcreateqty_){}
    , decltype(_impl_.totalwarrantcancelqty_){}
...
inline void MDWarrant::SharedCtor(
...
inline void MDWarrant::SharedDtor() {
...
const char* MDWarrant::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDWarrant.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      // int32 MDDate = 2;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDWarrant.TradingPhaseCode"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 37:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _impl_.warrantpremiumrate_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 38:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          _impl_.totalwarrantexecuteqty_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 39:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          _impl_.totalwarrantcreateqty_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 40:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          _impl_.totalwarrantcancelqty_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 72:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDWarrant.MarketPhaseCode"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 75:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 90)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDWarrant.TradingHaltReason"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDWarrant::_InternalSerialize(
  ...
  // int64 WarrantPremiumRate = 37;
  if (this->_internal_warrantpremiumrate() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(37, this->_internal_warrantpremiumrate(), target);
  }

  // int64 TotalWarrantExecuteQty = 38;
  if (this->_internal_totalwarrantexecuteqty() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(38, this->_internal_totalwarrantexecuteqty(), target);
  }

  // int64 TotalWarrantCreateQty = 39;
  if (this->_internal_totalwarrantcreateqty() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(39, this->_internal_totalwarrantcreateqty(), target);
  }

  // int64 TotalWarrantCancelQty = 40;
  if (this->_internal_totalwarrantcancelqty() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(40, this->_internal_totalwarrantcancelqty(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:com.htsc.mdc.insight.model.MDWarrant)
  ...
  if (this->_internal_warrantpremiumrate() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::Int64Size(
        this->_internal_warrantpremiumrate());
  }
  ...
  if (this->_internal_totalwarrantexecuteqty() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::Int64Size(
        this->_internal_totalwarrantexecuteqty());
  }
  ...
  if (this->_internal_totalwarrantcreateqty() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::Int64Size(
        this->_internal_totalwarrantcreateqty());
  }
  ...
  if (this->_internal_totalwarrantcancelqty() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::Int64Size(
        this->_internal_totalwarrantcancelqty());
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MDWarrant::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MDWarrant::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MDWarrant::GetClassData() const { return &_class_data_; }


void MDWarrant::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MDWarrant*>(&to_msg);
  auto& from = static_cast<const MDWarrant&>(from_msg);
  ...
  if (from._internal_warrantpremiumrate() != 0) {
    _this->_internal_set_warrantpremiumrate(from._internal_warrantpremiumrate());
  }
  if (from._internal_totalwarrantexecuteqty() != 0) {
    _this->_internal_set_totalwarrantexecuteqty(from._internal_totalwarrantexecuteqty());
  }
  if (from._internal_totalwarrantcreateqty() != 0) {
    _this->_internal_set_totalwarrantcreateqty(from._internal_totalwarrantcreateqty());
  }
  if (from._internal_totalwarrantcancelqty() != 0) {
    _this->_internal_set_totalwarrantcancelqty(from._internal_totalwarrantcancelqty());
  }
...
void MDWarrant::InternalSwap(MDWarrant* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDWarrant, _impl_.otcnumtrades_)
      + sizeof(MDWarrant::_impl_.otcnumtrades_)
      - PROTOBUF_FIELD_OFFSET(MDWarrant, _impl_.mddate_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata MDWarrant::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_MDWarrant_2eproto_getter, &descriptor_table_MDWarrant_2eproto_once,
      file_level_metadata_MDWarrant_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::MDWarrant*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::MDWarrant >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::MDWarrant >(arena);
}
