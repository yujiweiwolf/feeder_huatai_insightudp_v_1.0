...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR MDCfetsBondSnapshot::MDCfetsBondSnapshot(
...
struct MDCfetsBondSnapshotDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MDCfetsBondSnapshotDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MDCfetsBondSnapshotDefaultTypeInternal() {}
  union {
    MDCfetsBondSnapshot _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MDCfetsBondSnapshotDefaultTypeInternal _MDCfetsBondSnapshot_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_MDCfetsBondSnapshot_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_MDCfetsBondSnapshot_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_MDCfetsBondSnapshot_2eproto = nullptr;

const uint32_t TableStruct_MDCfetsBondSnapshot_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.transacttime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.marketindicator_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot, _impl_.datamultiplepowerof10_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::MDCfetsBondSnapshot)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_MDCfetsBondSnapshot_default_instance_._instance,
};

const char descriptor_table_protodef_MDCfetsBondSnapshot_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "etsBondSnapshotProtosH\001\240\001\001b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MDCfetsBondSnapshot_2eproto_deps[2] = {
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_MDCfetsBondSnapshot_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_MDCfetsBondSnapshot_2eproto = {
    false, false, 474, descriptor_table_protodef_MDCfetsBondSnapshot_2eproto,
    "MDCfetsBondSnapshot.proto",
    &descriptor_table_MDCfetsBondSnapshot_2eproto_once, descriptor_table_MDCfetsBondSnapshot_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_MDCfetsBondSnapshot_2eproto::offsets,
    file_level_metadata_MDCfetsBondSnapshot_2eproto, file_level_enum_descriptors_MDCfetsBondSnapshot_2eproto,
    file_level_service_descriptors_MDCfetsBondSnapshot_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_MDCfetsBondSnapshot_2eproto_getter() {
  return &descriptor_table_MDCfetsBondSnapshot_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_MDCfetsBondSnapshot_2eproto(&descriptor_table_MDCfetsBondSnapshot_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class MDCfetsBondSnapshot::_Internal {
 public:
};

MDCfetsBondSnapshot::MDCfetsBondSnapshot(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.MDCfetsBondSnapshot)
}
MDCfetsBondSnapshot::MDCfetsBondSnapshot(const MDCfetsBondSnapshot& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MDCfetsBondSnapshot* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void MDCfetsBondSnapshot::SharedCtor(
...
inline void MDCfetsBondSnapshot::SharedDtor() {
...
const char* MDCfetsBondSnapshot::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDCfetsBondSnapshot.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDCfetsBondSnapshot.TransactTime"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDCfetsBondSnapshot.MarketIndicator"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDCfetsBondSnapshot::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MDCfetsBondSnapshot::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MDCfetsBondSnapshot::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MDCfetsBondSnapshot::GetClassData() const { return &_class_data_; }


void MDCfetsBondSnapshot::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MDCfetsBondSnapshot*>(&to_msg);
  auto& from = static_cast<const MDCfetsBondSnapshot&>(from_msg);
...
void MDCfetsBondSnapshot::InternalSwap(MDCfetsBondSnapshot* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDCfetsBondSnapshot, _impl_.datamultiplepowerof10_)
      + sizeof(MDCfetsBondSnapshot::_impl_.datamultiplepowerof10_)
      - PROTOBUF_FIELD_OFFSET(MDCfetsBondSnapshot, _impl_.securitytype_)>(
          reinterpret_cast<char*>(&_impl_.securitytype_),
          reinterpret_cast<char*>(&other->_impl_.securitytype_));
}

::PROTOBUF_NAMESPACE_ID::Metadata MDCfetsBondSnapshot::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_MDCfetsBondSnapshot_2eproto_getter, &descriptor_table_MDCfetsBondSnapshot_2eproto_once,
      file_level_metadata_MDCfetsBondSnapshot_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::MDCfetsBondSnapshot*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::MDCfetsBondSnapshot >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::MDCfetsBondSnapshot >(arena);
}
