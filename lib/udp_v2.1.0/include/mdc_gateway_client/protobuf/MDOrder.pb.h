...
class MDOrder final :
 ...
 public:
  ...
  void set_tradedqty(int64_t value);
  private:
  int64_t _internal_tradedqty() const;
  void _internal_set_tradedqty(int64_t value);
  public:
...
inline void MDOrder::clear_tradedqty() {
  _impl_.tradedqty_ = int64_t{0};
}
inline int64_t MDOrder::_internal_tradedqty() const {
  return _impl_.tradedqty_;
}
inline int64_t MDOrder::tradedqty() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.MDOrder.TradedQty)
  return _internal_tradedqty();
}
inline void MDOrder::_internal_set_tradedqty(int64_t value) {
  
  _impl_.tradedqty_ = value;
}
inline void MDOrder::set_tradedqty(int64_t value) {
  _internal_set_tradedqty(value);
