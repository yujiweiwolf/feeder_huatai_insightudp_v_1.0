...
namespace insight {
namespace model {
PROTOBUF_CONSTEXPR MDFuture::MDFuture(
...
struct MDFutureDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MDFutureDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MDFutureDefaultTypeInternal() {}
  union {
    MDFuture _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MDFutureDefaultTypeInternal _MDFuture_default_instance_;
}  // namespace model
}  // namespace insight
}  // namespace mdc
}  // namespace htsc
}  // namespace com
static ::_pb::Metadata file_level_metadata_MDFuture_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_MDFuture_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_MDFuture_2eproto = nullptr;

const uint32_t TableStruct_MDFuture_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.htscsecurityid_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.mddate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.mdtime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.datatimestamp_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.tradingphasecode_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.securityidsource_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.securitytype_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.maxpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.minpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.preclosepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.numtrades_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.totalvolumetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.totalvaluetrade_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.lastpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.openpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.closepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.highpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.lowpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.tradingdate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.preopeninterest_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.presettleprice_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.openinterest_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.settleprice_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.predelta_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.currdelta_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.middlepx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.impliedbuypx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.impliedbuyqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.impliedsellpx_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.impliedsellqty_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.positiontrend_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.changespeed_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.changerate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.changevalue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.swing_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.commoditycontractnumber_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.exchangedate_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.exchangetime_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.channelno_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.buypricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.buyorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.sellpricequeue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.sellorderqtyqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.buyorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.sellorderqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.buynumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.sellnumordersqueue_),
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::MDFuture, _impl_.datamultiplepowerof10_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::com::htsc::mdc::insight::model::MDFuture)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::htsc::mdc::insight::model::_MDFuture_default_instance_._instance,
};

const char descriptor_table_protodef_MDFuture_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_MDFuture_2eproto_deps[2] = {
  &::descriptor_table_ESecurityIDSource_2eproto,
  &::descriptor_table_ESecurityType_2eproto,
};
static ::_pbi::once_flag descriptor_table_MDFuture_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_MDFuture_2eproto = {
    false, false, 1310, descriptor_table_protodef_MDFuture_2eproto,
    "MDFuture.proto",
    &descriptor_table_MDFuture_2eproto_once, descriptor_table_MDFuture_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_MDFuture_2eproto::offsets,
    file_level_metadata_MDFuture_2eproto, file_level_enum_descriptors_MDFuture_2eproto,
    file_level_service_descriptors_MDFuture_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_MDFuture_2eproto_getter() {
  return &descriptor_table_MDFuture_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_MDFuture_2eproto(&descriptor_table_MDFuture_2eproto);
namespace com {
namespace htsc {
namespace mdc {
namespace insight {
...
class MDFuture::_Internal {
 public:
};

MDFuture::MDFuture(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.htsc.mdc.insight.model.MDFuture)
}
MDFuture::MDFuture(const MDFuture& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MDFuture* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void MDFuture::SharedCtor(
...
inline void MDFuture::SharedDtor() {
...
const char* MDFuture::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDFuture.HTSCSecurityID"));
        } else
          goto handle_unusual;
        continue;
      // int32 MDDate = 2;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDFuture.TradingPhaseCode"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 36:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.MDFuture.CommodityContractNumber"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MDFuture::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MDFuture::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MDFuture::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MDFuture::GetClassData() const { return &_class_data_; }


void MDFuture::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MDFuture*>(&to_msg);
  auto& from = static_cast<const MDFuture&>(from_msg);
...
void MDFuture::InternalSwap(MDFuture* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MDFuture, _impl_.datamultiplepowerof10_)
      + sizeof(MDFuture::_impl_.datamultiplepowerof10_)
      - PROTOBUF_FIELD_OFFSET(MDFuture, _impl_.mddate_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata MDFuture::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_MDFuture_2eproto_getter, &descriptor_table_MDFuture_2eproto_once,
      file_level_metadata_MDFuture_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::com::htsc::mdc::insight::model::MDFuture*
Arena::CreateMaybeMessage< ::com::htsc::mdc::insight::model::MDFuture >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::htsc::mdc::insight::model::MDFuture >(arena);
}
