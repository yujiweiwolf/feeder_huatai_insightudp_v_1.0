...
template<> ::com::htsc::mdc::insight::model::LinkInfo* Arena::CreateMaybeMessage<::com::htsc::mdc::insight::model::LinkInfo>(Arena*);
...
class LoginRequest final :
 ...
 public:
  ...
  private:
  bool _internal_has_linkinfo() const;
  public:
  void clear_linkinfo();
  const ::com::htsc::mdc::insight::model::LinkInfo& linkinfo() const;
  PROTOBUF_NODISCARD ::com::htsc::mdc::insight::model::LinkInfo* release_linkinfo();
  ...
  private:
  const ::com::htsc::mdc::insight::model::LinkInfo& _internal_linkinfo() const;
  ::com::htsc::mdc::insight::model::LinkInfo* _internal_mutable_linkinfo();
  public:
  void unsafe_arena_set_allocated_linkinfo(
      ::com::htsc::mdc::insight::model::LinkInfo* linkinfo);
  ::com::htsc::mdc::insight::model::LinkInfo* unsafe_arena_release_linkinfo();
...
class LinkInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.htsc.mdc.insight.model.LinkInfo) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.htsc.mdc.insight.model.LinkInfo";
  }
  protected:
  ...
  enum : int {
    kLinkProcessIdFieldNumber = 1,
    kLinkTotalNumFieldNumber = 2,
    kLinkSeqFieldNumber = 3,
  };
  // string LinkProcessId = 1;
  void clear_linkprocessid();
  const std::string& linkprocessid() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_linkprocessid(ArgT0&& arg0, ArgT... args);
  std::string* mutable_linkprocessid();
  PROTOBUF_NODISCARD std::string* release_linkprocessid();
  void set_allocated_linkprocessid(std::string* linkprocessid);
  private:
  const std::string& _internal_linkprocessid() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_linkprocessid(const std::string& value);
  std::string* _internal_mutable_linkprocessid();
  public:

  // int32 LinkTotalNum = 2;
  void clear_linktotalnum();
  int32_t linktotalnum() const;
  void set_linktotalnum(int32_t value);
  private:
  int32_t _internal_linktotalnum() const;
  void _internal_set_linktotalnum(int32_t value);
  public:

  // int32 LinkSeq = 3;
  void clear_linkseq();
  int32_t linkseq() const;
  void set_linkseq(int32_t value);
  private:
  int32_t _internal_linkseq() const;
  void _internal_set_linkseq(int32_t value);
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr linkprocessid_;
    int32_t linktotalnum_;
    int32_t linkseq_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
// .com.htsc.mdc.insight.model.LinkInfo linkInfo = 9;
inline bool LoginRequest::_internal_has_linkinfo() const {
  return this != internal_default_instance() && _impl_.linkinfo_ != nullptr;
}
inline bool LoginRequest::has_linkinfo() const {
  return _internal_has_linkinfo();
}
...
inline const ::com::htsc::mdc::insight::model::LinkInfo& LoginRequest::_internal_linkinfo() const {
  const ::com::htsc::mdc::insight::model::LinkInfo* p = _impl_.linkinfo_;
  return p != nullptr ? *p : reinterpret_cast<const ::com::htsc::mdc::insight::model::LinkInfo&>(
      ::com::htsc::mdc::insight::model::_LinkInfo_default_instance_);
}
inline const ::com::htsc::mdc::insight::model::LinkInfo& LoginRequest::linkinfo() const {
  ...
  return _internal_linkinfo();
}
inline void LoginRequest::unsafe_arena_set_allocated_linkinfo(
    ::com::htsc::mdc::insight::model::LinkInfo* linkinfo) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.linkinfo_);
  }
  _impl_.linkinfo_ = linkinfo;
  if (linkinfo) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:com.htsc.mdc.insight.model.LoginRequest.linkInfo)
}
inline ::com::htsc::mdc::insight::model::LinkInfo* LoginRequest::release_linkinfo() {
  
  ::com::htsc::mdc::insight::model::LinkInfo* temp = _impl_.linkinfo_;
  _impl_.linkinfo_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::com::htsc::mdc::insight::model::LinkInfo* LoginRequest::unsafe_arena_release_linkinfo() {
...
inline ::com::htsc::mdc::insight::model::LinkInfo* LoginRequest::_internal_mutable_linkinfo() {
  
  if (_impl_.linkinfo_ == nullptr) {
    auto* p = CreateMaybeMessage<::com::htsc::mdc::insight::model::LinkInfo>(GetArenaForAllocation());
    _impl_.linkinfo_ = p;
  }
  return _impl_.linkinfo_;
}
inline ::com::htsc::mdc::insight::model::LinkInfo* LoginRequest::mutable_linkinfo() {
  ::com::htsc::mdc::insight::model::LinkInfo* _msg = _internal_mutable_linkinfo();
...
inline void LoginRequest::set_allocated_linkinfo(::com::htsc::mdc::insight::model::LinkInfo* linkinfo) {
  ...
  if (linkinfo) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(linkinfo);
    if (message_arena != submessage_arena) {
      linkinfo = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, linkinfo, submessage_arena);
    }
...
inline const std::string& LinkInfo::linkprocessid() const {
  ...
  return _internal_linkprocessid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LinkInfo::set_linkprocessid(ArgT0&& arg0, ArgT... args) {
 
 _impl_.linkprocessid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* LinkInfo::mutable_linkprocessid() {
  std::string* _s = _internal_mutable_linkprocessid();
  // @@protoc_insertion_point(field_mutable:com.htsc.mdc.insight.model.LinkInfo.LinkProcessId)
  return _s;
}
inline const std::string& LinkInfo::_internal_linkprocessid() const {
  return _impl_.linkprocessid_.Get();
}
inline void LinkInfo::_internal_set_linkprocessid(const std::string& value) {
  
  _impl_.linkprocessid_.Set(value, GetArenaForAllocation());
}
inline std::string* LinkInfo::_internal_mutable_linkprocessid() {
  
  return _impl_.linkprocessid_.Mutable(GetArenaForAllocation());
}
inline std::string* LinkInfo::release_linkprocessid() {
  ...
  return _impl_.linkprocessid_.Release();
}
inline void LinkInfo::set_allocated_linkprocessid(std::string* linkprocessid) {
  if (linkprocessid != nullptr) {
    
  } else {
    
  }
  _impl_.linkprocessid_.SetAllocated(linkprocessid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.linkprocessid_.IsDefault()) {
...
inline void LinkInfo::clear_linktotalnum() {
  _impl_.linktotalnum_ = 0;
}
inline int32_t LinkInfo::_internal_linktotalnum() const {
  return _impl_.linktotalnum_;
}
inline int32_t LinkInfo::linktotalnum() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.LinkInfo.LinkTotalNum)
  return _internal_linktotalnum();
}
inline void LinkInfo::_internal_set_linktotalnum(int32_t value) {
  
  _impl_.linktotalnum_ = value;
}
inline void LinkInfo::set_linktotalnum(int32_t value) {
  _internal_set_linktotalnum(value);
...
inline int32_t LinkInfo::_internal_linkseq() const {
  return _impl_.linkseq_;
}
inline int32_t LinkInfo::linkseq() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.LinkInfo.LinkSeq)
  return _internal_linkseq();
}
inline void LinkInfo::_internal_set_linkseq(int32_t value) {
  
  _impl_.linkseq_ = value;
}
inline void LinkInfo::set_linkseq(int32_t value) {
  _internal_set_linkseq(value);
