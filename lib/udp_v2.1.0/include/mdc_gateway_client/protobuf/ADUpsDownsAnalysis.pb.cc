...
const uint32_t TableStruct_ADUpsDownsAnalysis_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::com::htsc::mdc::insight::model::ADUpsDownsCount, _impl_.leadingupids_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 33, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADUpsDownsLimitCount)},
  { 47, -1, -1, sizeof(::com::htsc::mdc::insight::model::ADUpsDownsPartitionDetail)},
};
...
const char descriptor_table_protodef_ADUpsDownsAnalysis_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "wnsAnalysisProtosH\001\240\001\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_ADUpsDownsAnalysis_2eproto = {
    false, false, 1190, descriptor_table_protodef_ADUpsDownsAnalysis_2eproto,
...
ADUpsDownsCount::ADUpsDownsCount(const ADUpsDownsCount& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.leadingupids_){from._impl_.leadingupids_}
...
inline void ADUpsDownsCount::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.leadingupids_){arena}
    , decltype(_impl_.ups_){0}
    , decltype(_impl_.downs_){0}
    , decltype(_impl_.equals_){0}
    , decltype(_impl_.preups_){0}
...
inline void ADUpsDownsCount::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.leadingupids_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 74)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_leadingupids();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "com.htsc.mdc.insight.model.ADUpsDownsCount.LeadingUpIds"));
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<74>(ptr));
        } else
          goto handle_unusual;
...
uint8_t* ADUpsDownsCount::_InternalSerialize(
  ...
  // repeated string LeadingUpIds = 9;
  for (int i = 0, n = this->_internal_leadingupids_size(); i < n; i++) {
    const auto& s = this->_internal_leadingupids(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
// @@protoc_insertion_point(message_byte_size_start:com.htsc.mdc.insight.model.ADUpsDownsCount)
  ...
  // repeated string LeadingUpIds = 9;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.leadingupids_.size());
  for (int i = 0, n = _impl_.leadingupids_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.leadingupids_.Get(i));
  }
...
void ADUpsDownsCount::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.leadingupids_.MergeFrom(from._impl_.leadingupids_);
...
void ADUpsDownsCount::InternalSwap(ADUpsDownsCount* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.leadingupids_.InternalSwap(&other->_impl_.leadingupids_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
